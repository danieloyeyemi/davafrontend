                ...
                <div class="container-fluid bg-dark">
                    ...
                    <div className="collapse navbar-collapse bg-dark" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item bg-dark">
                                <p className="nav-link mx-5 mt-3 sign bg-success" aria-current="page"><Link className='text-decoration-none text-light bg-success' to="/user">Signup</Link></p>
                            </li>
                            <li class="nav-item bg-dark">
                                <p className="nav-link mt-3 sign mx-5 bg-primary" aria-current="page"><Link className="text-decoration-none text-light bg-primary" to="/userlogin">Login</Link></p>
                            </li>
                        </ul>
